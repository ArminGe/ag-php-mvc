...
abstract class Model
{
    ...
    public function errorMessages()
    {
        return [
            ...
            self::RULE_MATCH => 'This field must contain the same content as {match}',
            self::RULE_UNIQUE => 'There is already an account registered with this {field}!',
